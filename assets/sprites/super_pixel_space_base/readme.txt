...
Hello! Thank you for downloading the Super Pixel Space Base Tileset. Here are a few pointers to help you navigate and make sense of this zip file.

- In the root folder, you will find three style folders. These folders correspond to each tileset color style.
...
- Pretty much every object and tile is a size multiple of 16x16 pixels. They're made to stick to an 8x8 grid, but you don't necessarily have to stick to a grid if you don't want to.
