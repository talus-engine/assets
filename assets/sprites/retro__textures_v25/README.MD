# RETRO TEXTURES BUNDLE

Hey, thanks so much for trying out my retro-style textures pack. I started
...
There is currently a total of *637* unique textures, though there are a lot of
...
pack in any format, even if you have modified them. The textures may not be used
to train AI models.
